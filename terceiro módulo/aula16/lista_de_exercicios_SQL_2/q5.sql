...
select Alunos.nome as Nome_Aluno, Cursos.nome_curso as Curso from Alunos, Cursos, Matriculas where Alunos.id = Matriculas.aluno_id and Cursos.id = Matriculas.curso_id